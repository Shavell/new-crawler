...
def generate_migrate():
    example = [
        ...
        {
            'definition': 'beb',
            'tracking_id': 'RV940053108CN'
        },
        {
            'definition': 'ftdi',
            'tracking_id': 'UR555366336CN'
        },
        {
            'definition': 'driver',
            'tracking_id': 'LL431123972CN'
        },
        {
            'definition': 'edptypeb1',
            'tracking_id': 'RV931401122CN'
        },
        {
            'definition': 'edptypeb2',
            'tracking_id': 'RV930280621CN'
        },
        {
            'definition': 'edpsame',
            'tracking_id': 'LL389839763CN'
        },
        {
            'definition': 'trityum',
            'tracking_id': 'RP610225821CN'
        },
        {
            'definition': 'gsmanten',
            'tracking_id': 'RB762582733SG'
        }
    ]
    for i in example:
